...
/*function add_scripts() {
  wp_enqueue_script('google-maps', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyD4Eg5R8ZRHnASzTEkqkJeZXNhuafQEUfM',true); 
  wp_enqueue_script('google-jsapi','https://www.google.com/jsapi',true); 
  wp_enqueue_script('route_maps', 'http://localhost/mcginley/wp-content/themes//customizer-child/scripts/myMaps.js',true); 
  wp_enqueue_script('google-maps'); 
wp_enqueue_script('google-jsapi'); 
wp_enqueue_script('route_maps'); 
}
add_action('wp_enqueue_scripts', 'add_scripts');*/

/*function google_maps_api() { 
wp_register_script( 'googlemap', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyD4Eg5R8ZRHnASzTEkqkJeZXNhuafQEUfM',true); 
wp_register_script( 'route_maps', 'http://localhost/mcginley/wp-content/themes//customizer-child/scripts/myMaps',true); 
